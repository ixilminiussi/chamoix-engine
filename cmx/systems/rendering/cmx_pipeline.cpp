...
void CmxPipeline::createGraphicsPipeline(const std::string &vertFilepath, const std::string &fragFilepath,
                                         const PipelineConfigInfo &configInfo)
{
    ...
    std::vector<VkVertexInputBindingDescription> bindingDescriptions = CmxModel::Vertex::getBindingDescriptions();
    std::vector<VkVertexInputAttributeDescription> attributeDescriptions = CmxModel::Vertex::getAttributeDescriptions();
...
void CmxPipeline::createShaderModule(const std::vector<char> &code, VkShaderModule *shaderModule)
{
...
void CmxPipeline::defaultPipelineConfigInfo(PipelineConfigInfo &configInfo)
{
