...
void PostInspectorMaterial::bind(FrameInfo *frameInfo, const Drawable *)
{
    if (_boundID != _id)
    {
...
void PostInspectorMaterial::editor()
{
    Material::editor();

    static std::map<int, std::string> options{{0, "nothing"}, {1, "albedo"}, {2, "shadow"},
                                              {3, "normal"},  {4, "depth"},  {5, "ssao"}};
...
tinyxml2::XMLElement *PostInspectorMaterial::save(tinyxml2::XMLDocument &doc, tinyxml2::XMLElement *parentElement) const
{
...
void PostInspectorMaterial::load(tinyxml2::XMLElement *materialElement)
{
...
void PostInspectorMaterial::initialize()
{
...
void PostInspectorMaterial::createPipelineLayout(std::vector<vk::DescriptorSetLayout> descriptorSetLayouts)
{
...
void PostInspectorMaterial::createPipeline(vk::RenderPass renderPass)
{
