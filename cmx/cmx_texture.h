...
class CmxTexture
{
  public:
    ...
    CmxTexture(std::shared_ptr<class CmxDevice>, const CmxTexture::Builder &, const std::string &name);
    ~CmxTexture() = default;
    ...
    static std::shared_ptr<CmxTexture> createTextureFromFile(std::shared_ptr<class CmxDevice>,
