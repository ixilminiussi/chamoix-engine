...
inline const char *toString(InputSource inputSource)
{
    switch (inputSource)
    {
...
inline InputSource toInputSource(const char *sourceString)
{
...
inline static const std::pair<const char *, Axis *> CMX_AXIS_DICTIONARY[] = {
