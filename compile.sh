...
SHADERS=("void.vert" "void.frag" "dithered_t.vert" "dithered_t.frag" "dithered.vert" "dithered.frag" "shaded.vert" "shaded.frag" "mesh.vert" "mesh.frag" "billboard.vert" "billboard.frag" "parallax.vert" "parallax.frag" "hud.vert" "hud.frag" "postprocess.vert" "post_outline.frag")
