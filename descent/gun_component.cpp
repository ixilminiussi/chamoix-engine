...
GunInfo GunComponent::gattlingGun = GunInfo{.15f, 50, BulletInfo{50.f, .4f, 0, 50, 0b10000000, {1.f, 1.f, 1.f}}};
...
void GunComponent::shoot()
{
    ...
    BulletActor *actor = cmx::Actor::spawn<BulletActor>(getScene(), name.c_str(), transform);
